# University Museum – Documentation Index

This folder contains the complete documentation for the Tourist Guidance Museum (TGM) monorepo.
...
| [security.md](./security.md)         | Security hardening applied (headers, input validation, storage) |
| [performance.md](./performance.md)   | Caching strategy, ISR, column projection, animations            |
| [responsive.md](./responsive.md)     | Breakpoints, mobile-first approach, per-component details       |
| [deployment.md](./deployment.md)     | Vercel deployment, environment variables, build commands        |
